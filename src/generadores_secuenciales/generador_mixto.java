 ...
 * @author jacc
 */
public class generador_mixto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btn_calcular, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 390, -1, -1));
    ...
    private void btn_calcularMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_calcularMouseClicked
        ...
        if (txt_d.getText().equalsIgnoreCase("") && txt_k.getText().equalsIgnoreCase("") && txt_x.getText().equalsIgnoreCase("")) { //verifica si estan ingresadas todas las variables
            ...
            String columnaCabezera[] = {"n", "Xn", a + "Xn + " + c + " mod " + m, "Xn+1", "Numeros uniformes"}; //almacenamos los valores de la primera fila
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(generador_mixto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new generador_mixto().setVisible(true);
            }
        });
